...
<html lang="en">
  ...
  <frameset cols="240,*" framespacing="0" border="0" id="frame-body">
    ...
    <frame src="/range/Grade/gradeList" id="menu-frame" name="menu-frame" frameborder="no" scrolling="no">
    <frame src="/range/Grade/main" id="grade-main-frame" name="grade-main-frame" frameborder="no" scrolling="no">
  </frameset>
  <frame src="/range/Grade/footer" id="footer-frame" name="footer-frame" frameborder="no" scrolling="no">
<noframes></noframes>
