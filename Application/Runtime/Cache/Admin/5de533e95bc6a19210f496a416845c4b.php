...
<div class="navbar">
        <div class="navbar-inner">
                <ul class="nav pull-right">
                   <li><a  href="<?php echo U('Login/login_out','','');?>"  target="_top">安全退出</a></li>
                    ...
                    <li id="fat-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a tabindex="-1" class="visible-phone" href="#">在哪里</a></li>
                ...
                <a class="brand" href="index.html"><span class="second">维新</span><span class="first">让微信从此简单</span> </a>
        </div>
    </div>
