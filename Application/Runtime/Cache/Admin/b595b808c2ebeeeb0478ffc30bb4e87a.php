...
<html lang="en">
  ...
  <!--[if (gt IE 9)|!(IE)]><!--> 
  <frameset rows="41,*,41" framespacing="0" border="0" >
  <frame src="/range/Index/head" id="header-frame" name="header-frame" frameborder="no" scrolling="no">
  <frameset cols="240,*" framespacing="0" border="0" id="frame-body">
    <frame src="/range/Index/menu" id="menu-frame" name="menu-frame" frameborder="no" scrolling="no">
    <frame src="/range/Index/main" id="main-frame" name="main-frame" frameborder="no" scrolling="auto">
  </frameset>
  <frame src="/range/Index/footer" id="footer-frame" name="footer-frame" frameborder="no" scrolling="no">
