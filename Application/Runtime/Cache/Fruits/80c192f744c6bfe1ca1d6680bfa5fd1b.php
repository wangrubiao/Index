...
<link href="/weChat/Public/<?php echo (C("projectName")); ?>/css/global_site_base.css" rel="stylesheet" type="text/css">
<link href="/weChat/Public/<?php echo (C("projectName")); ?>/css/h5Index.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/weChat/Public/<?php echo (C("projectName")); ?>/js/global_base_tracker.js" charset="utf-8"></script>
<script type="text/javascript" src="/weChat/Public/<?php echo (C("projectName")); ?>/js/global_base_common.js" charset="utf-8"></script>
</head>
<body>
...
<div class="mine_main_content">
  <div class="desc">
    <div class="img"><img src="/weChat/Public/<?php echo (C("projectName")); ?>/images/tx.jpg"/></div>
    <div class="user_info"> <span>欢迎回来！</span> <span>会员号：<?php echo ($account); ?></span>
      <ul>
  ...
  <ul>
    <li><a id="yhdlogistics" href="../../../weChat/Fruits/Index/privilege" data-tpa="1446"><b>了解会员消费权益</b><i>定期更新</i></a></li>
  </ul>
  <ul>
    <li><a id="yhdorder" href="../../../weChat/Fruits/Index/order#" data-tpa="1447">我的订单</a></li>
		<li><a id="mycou" href="../../../weChat/Fruits/Index/detail" data-tpa="1448">积分明细</a></li>
    <li><a id="mycou" href="http://m.yhd.com/mycouplist/1/1" data-tpa="1448">我的抵用劵<i>0</i></a></li>
	
    <li><a id="myReservation" href="http://spb.m.yhd.com/inshop_product/reservationH5/findMyReservation.action" data-tpa="2711">生日特权</a></li>
  </ul>
  <ul>
  ...
  <a href="../Login/logout" data-tpa="1456" class="logout">退出当前账户</a> </div>
