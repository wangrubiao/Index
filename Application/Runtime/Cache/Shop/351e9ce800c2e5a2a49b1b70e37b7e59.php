...
<div id="page">
  ...
  <article class="showcontent">
    ...
    <div class="btn">
      ...
      <a target="_blank" href="javascript:void(0)"><img border="0" src="http://wpa.qq.com/pa?p=2:2278906920:51" alt="订单查询" title="订单查询"/></a> 
      <!--<a class="btn" href="sms:13246891178">订 单 查 询</a>-->
      </div>
  </article>
  <article id="buy">
    <h2 name="buy">订单信息</h2>
